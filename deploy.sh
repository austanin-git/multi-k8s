...
kubectl set image deployments/client-deployment server=austanin/multi-client:$SHA
kubectl set image deployments/worker-deployment server=austanin/multi-worker:$SHA
